...
export const TEAM_MEMBERS = [
  {
    ...
    bio_short: `${jeff_cole_bio.slice(0, 49)}...`,
    bio: jeff_cole_bio,
    link: '#pablo'
  },
  {
    ...
    bio_short: 'Jill Hodges is Get Ink PR’s go-to girl when it comes to brand strategy, creative direction and graphic design. Jill’s design roots started in the “dot com” craze as a senior designer...',
    bio: 'text'
  },
  {
    img: FaceJWebb,
    fullName: 'Jeff Webb',
    title: 'Web Developer',
    bio_short: `${jeff_webb_bio.slice(0, 49)}...`,
    bio: jeff_webb_bio
  }
]
